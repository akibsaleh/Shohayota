...
const About = ({ aboutRef }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-3/4 max-w-[682px] relative text-center lg:text-left">
        <img
          src={arrowTopLeft}
        ...
        <h2
          ref={aboutRef}
          className={`pb-4 ${isBn ? 'font-lss text-3xl md:text-[40px]' : 'font-archivo text-3xl md:text-[42px] font-extrabold leading-[56px]'} px-5 md:pb-0`}
        >
          {t('about.title')}
        </h2>
